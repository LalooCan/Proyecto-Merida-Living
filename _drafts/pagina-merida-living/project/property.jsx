    ...
    <section data-screen-label="Galería principal">
      ...
      <div className="container-wide hg-wrap">
        <div className="hg-grid" style={{position:'relative'}}>
          ...
          <ImgSlot id="slot-prop-P-01-g2" placeholder="Recámara principal" style={{width:'100%', height:'100%', display:'block'}}/>
          <ImgSlot id="slot-prop-P-01-g3" placeholder="Cocina" style={{width:'100%', height:'100%', display:'block'}}/>
          <ImgSlot id="slot-prop-P-01-g4" placeholder="Alberca y palapa" style={{width:'100%', height:'100%', display:'block'}}/>
          <div className="hg-more">
            <ImgSlot id="slot-prop-P-01-g5" placeholder="Fachada" style={{width:'100%', height:'100%', display:'block'}}/>
          ...
          <aside className="ov-rail">
            <div className="price-card">
              ...
              <div className="agent-row">
                <div className="av">
                  <ImgSlot id="slot-agent-andrea" placeholder="A" shape="circle"/>
                </div>
                <div>

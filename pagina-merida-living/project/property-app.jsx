        ...
        <div className="fm-grid">
          ...
          <div className="fm-card">
            ...
            <div className="fp-body">
              <ImgSlot id="slot-prop-P-01-floorplan" placeholder="Plano arquitectónico · planta baja" fit="contain"/>
            </div>
        ...
        <div className="cf-grid">
          <div>
            ...
            <div className="cf-agent">
              <div className="av">
                <ImgSlot id="slot-agent-andrea" placeholder="Andrea" shape="circle"/>
              </div>
              <div>
        ...
        <div className="sp-grid">
          {similar.map(p => (
            <a className="sp-card" key={p.id} href="property.html">
              <div className="img">
                <ImgSlot id={`slot-${p.id}-cover`} placeholder={`Foto · ${p.name}`}/>
              </div>
              <div className="lc">
